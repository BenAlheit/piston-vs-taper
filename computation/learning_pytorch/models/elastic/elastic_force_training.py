...
from computation.learning_pytorch.data_sets import CapElasticDataset
...
def train_regression_model(params,
                           data_set=CapElasticDataset('../../data/cap/processed_test_data.csv'),
                           plot=False):
    ...
    model_path = f"./trained/elastic_mid_dim_{n_mid}_n_hidden_{n_hidden}.pth"
